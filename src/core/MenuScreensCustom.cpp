...
CMenuScreenCustom aScreens[] = {
	...
	{ "FET_LG", MENUPAGE_NEW_GAME, nil, nil,
		...
		MENUACTION_CHECKSAVE,	"FEM_AS",  {nil, SAVESLOT_9,		0}, 0, 0, MENUALIGN_LEFT,
	...
	{ "FEC_MOU", MENUPAGE_CONTROLLER_PC, nil, nil,
		...
		MENUACTION_1STPERSONSENS,	"FEC_FPS",	{nil, SAVESLOT_NONE, MENUPAGE_MOUSE_CONTROLS}, 40, 190, MENUALIGN_LEFT,
	...
	{ "FET_PAU", MENUPAGE_DISABLED, nil, nil,
		...
		MENUACTION_CHANGEMENU,  "FET_SG" ,  {nil, SAVESLOT_NONE, MENUPAGE_CHOOSE_SAVE_SLOT}, 0, 0, MENUALIGN_CENTER,
